...
INSERT INTO taches_qualite (id, projet_id, famille_code, famille_libelle, indicateur, livrable, fait, date_echeance) VALUES
  -- Projet 1
  ('tq100000-0000-0000-0000-000000000001', 'p1000000-0000-0000-0000-000000000001', 'C1', 'Conditions d''information', 'Information prealable', 'Fiche formation publiee', true, '2025-02-15'),
  ('tq100000-0000-0000-0000-000000000002', 'p1000000-0000-0000-0000-000000000001', 'C2', 'Objectifs de formation', 'Competences visees definies', 'Referentiel competences', true, '2025-02-28'),
  ('tq100000-0000-0000-0000-000000000003', 'p1000000-0000-0000-0000-000000000001', 'ADM', 'Administratif', 'Dossier administratif complet', 'Cerfa signe', false, '2025-04-30'),
  ('tq100000-0000-0000-0000-000000000004', 'p1000000-0000-0000-0000-000000000001', 'HQ', 'Hors Qualiopi', 'Suivi mensuel', 'Rapport mensuel', false, '2025-05-31'),
  -- Projet 2
  ('tq100000-0000-0000-0000-000000000005', 'p1000000-0000-0000-0000-000000000002', 'C1', 'Conditions d''information', 'Information prealable', 'Programme de formation', true, '2025-03-15'),
  ('tq100000-0000-0000-0000-000000000006', 'p1000000-0000-0000-0000-000000000002', 'ADM', 'Administratif', 'Convention signee', 'Convention tripartite', false, '2025-04-15'),
  ('tq100000-0000-0000-0000-000000000007', 'p1000000-0000-0000-0000-000000000002', 'C2', 'Objectifs de formation', 'Evaluation initiale', 'Test de positionnement', true, '2025-03-31'),
  -- Projet 3
  ('tq100000-0000-0000-0000-000000000008', 'p1000000-0000-0000-0000-000000000003', 'C1', 'Conditions d''information', 'Information prealable', 'Plaquette formation', true, '2025-02-20'),
  ('tq100000-0000-0000-0000-000000000009', 'p1000000-0000-0000-0000-000000000003', 'C2', 'Objectifs de formation', 'Competences visees', 'Referentiel RNCP', true, '2025-03-15'),
  ('tq100000-0000-0000-0000-000000000010', 'p1000000-0000-0000-0000-000000000003', 'ADM', 'Administratif', 'Contrat signe', 'Contrat apprentissage', false, '2025-04-30'),
  ('tq100000-0000-0000-0000-000000000011', 'p1000000-0000-0000-0000-000000000003', 'HQ', 'Hors Qualiopi', 'Bilan intermediaire', 'Compte-rendu bilan', false, '2025-06-30'),
  ('tq100000-0000-0000-0000-000000000012', 'p1000000-0000-0000-0000-000000000003', 'C1', 'Conditions d''information', 'Reglement interieur', 'RI signe', true, '2025-03-01'),
  -- Projet 4
  ('tq100000-0000-0000-0000-000000000013', 'p1000000-0000-0000-0000-000000000004', 'C1', 'Conditions d''information', 'Programme detaille', 'Syllabus', true, '2025-04-15'),
  ('tq100000-0000-0000-0000-000000000014', 'p1000000-0000-0000-0000-000000000004', 'ADM', 'Administratif', 'Convention formation', 'Convention signee', false, '2025-05-01'),
  ('tq100000-0000-0000-0000-000000000015', 'p1000000-0000-0000-0000-000000000004', 'C2', 'Objectifs de formation', 'Modalites evaluation', 'Grille evaluation', false, '2025-05-15'),
  -- Projet 5
  ('tq100000-0000-0000-0000-000000000016', 'p1000000-0000-0000-0000-000000000005', 'C1', 'Conditions d''information', 'Information prealable', 'Fiche formation', true, '2025-06-15'),
  ('tq100000-0000-0000-0000-000000000017', 'p1000000-0000-0000-0000-000000000005', 'C2', 'Objectifs de formation', 'Positionnement initial', 'Test entree', false, '2025-07-01'),
  ('tq100000-0000-0000-0000-000000000018', 'p1000000-0000-0000-0000-000000000005', 'ADM', 'Administratif', 'Dossier inscription', 'Dossier complet', false, '2025-07-15'),
  -- Projet 6
  ('tq100000-0000-0000-0000-000000000019', 'p1000000-0000-0000-0000-000000000006', 'C1', 'Conditions d''information', 'Programme formation', 'Programme detaille', true, '2025-02-01'),
  ('tq100000-0000-0000-0000-000000000020', 'p1000000-0000-0000-0000-000000000006', 'ADM', 'Administratif', 'Convention POEI', 'Convention signee', true, '2025-02-15'),
  ('tq100000-0000-0000-0000-000000000021', 'p1000000-0000-0000-0000-000000000006', 'HQ', 'Hors Qualiopi', 'Suivi entreprise', 'CR visite entreprise', false, '2025-04-30');
...
INSERT INTO saisies_temps (id, user_id, projet_id, date, heures) VALUES
  ...
  ('st100000-0000-0000-0000-000000000001', (SELECT id FROM users ORDER BY created_at LIMIT 1), 'p1000000-0000-0000-0000-000000000001', '2026-04-06', 3.00),
  ('st100000-0000-0000-0000-000000000002', (SELECT id FROM users ORDER BY created_at LIMIT 1), 'p1000000-0000-0000-0000-000000000003', '2026-04-06', 4.00),
  ('st100000-0000-0000-0000-000000000003', (SELECT id FROM users ORDER BY created_at LIMIT 1), 'p1000000-0000-0000-0000-000000000001', '2026-04-07', 5.00),
  ('st100000-0000-0000-0000-000000000004', (SELECT id FROM users ORDER BY created_at LIMIT 1), 'p1000000-0000-0000-0000-000000000002', '2026-04-07', 2.00),
  ('st100000-0000-0000-0000-000000000005', (SELECT id FROM users ORDER BY created_at LIMIT 1), 'p1000000-0000-0000-0000-000000000003', '2026-04-08', 7.00),
  ('st100000-0000-0000-0000-000000000006', (SELECT id FROM users ORDER BY created_at LIMIT 1), 'p1000000-0000-0000-0000-000000000001', '2026-04-09', 4.00),
  ('st100000-0000-0000-0000-000000000007', (SELECT id FROM users ORDER BY created_at LIMIT 1), 'p1000000-0000-0000-0000-000000000005', '2026-04-09', 3.00),
  ('st100000-0000-0000-0000-000000000008', (SELECT id FROM users ORDER BY created_at LIMIT 1), 'p1000000-0000-0000-0000-000000000004', '2026-04-10', 6.00);
...
INSERT INTO echeances (id, projet_id, mois_concerne, date_emission_prevue, montant_prevu_ht, validee) VALUES
  ...
  ('ec100000-0000-0000-0000-000000000001', 'p1000000-0000-0000-0000-000000000001', '2025-01-01', '2025-02-01', 320.83, true),
  ('ec100000-0000-0000-0000-000000000002', 'p1000000-0000-0000-0000-000000000001', '2025-02-01', '2025-03-01', 320.83, true),
  ('ec100000-0000-0000-0000-000000000003', 'p1000000-0000-0000-0000-000000000001', '2025-03-01', '2025-04-01', 320.83, false),
  -- Projet 3: 2 echeances
  ('ec100000-0000-0000-0000-000000000004', 'p1000000-0000-0000-0000-000000000003', '2025-02-01', '2025-03-01', 260.42, true),
  ('ec100000-0000-0000-0000-000000000005', 'p1000000-0000-0000-0000-000000000003', '2025-03-01', '2025-04-01', 260.42, false),
  -- Projet 5: 1 echeance
  ('ec100000-0000-0000-0000-000000000006', 'p1000000-0000-0000-0000-000000000005', '2025-06-01', '2025-07-01', 308.33, false);
...
INSERT INTO facture_lignes (id, facture_id, contrat_id, description, montant_ht) VALUES
  -- Facture 1 lignes
  ('fl100000-0000-0000-0000-000000000001', 'fa100000-0000-0000-0000-000000000001', 'ct100000-0000-0000-0000-000000000001',
   'Commission 10% — Developpeur Web Full Stack — Yann Kerlouegan — janvier 2025', 100.00),
  ('fl100000-0000-0000-0000-000000000002', 'fa100000-0000-0000-0000-000000000001', 'ct100000-0000-0000-0000-000000000002',
   'Commission 10% — Developpeur Web Full Stack — Anna Le Bihan — janvier 2025', 95.83),
  ('fl100000-0000-0000-0000-000000000003', 'fa100000-0000-0000-0000-000000000001', 'ct100000-0000-0000-0000-000000000003',
   'Commission 10% — Admin Systemes et Reseaux — Elodie Morvan — janvier 2025', 125.00),
  -- Facture 2 lignes
  ('fl100000-0000-0000-0000-000000000004', 'fa100000-0000-0000-0000-000000000002', 'ct100000-0000-0000-0000-000000000001',
   'Commission 10% — Developpeur Web Full Stack — Yann Kerlouegan — fevrier 2025', 100.00),
  ('fl100000-0000-0000-0000-000000000005', 'fa100000-0000-0000-0000-000000000002', 'ct100000-0000-0000-0000-000000000002',
   'Commission 10% — Developpeur Web Full Stack — Anna Le Bihan — fevrier 2025', 95.83),
  ('fl100000-0000-0000-0000-000000000006', 'fa100000-0000-0000-0000-000000000002', 'ct100000-0000-0000-0000-000000000003',
   'Commission 10% — Admin Systemes et Reseaux — Elodie Morvan — fevrier 2025', 125.00),
  -- Facture 3 lignes
  ('fl100000-0000-0000-0000-000000000007', 'fa100000-0000-0000-0000-000000000003', 'ct100000-0000-0000-0000-000000000006',
   'Commission 10% — Comptabilite Gestion — Lucas Martin — fevrier 2025', 58.33),
  ('fl100000-0000-0000-0000-000000000008', 'fa100000-0000-0000-0000-000000000003', 'ct100000-0000-0000-0000-000000000007',
   'Commission 10% — Comptabilite Gestion — Emma Petit — fevrier 2025', 58.33),
  ('fl100000-0000-0000-0000-000000000009', 'fa100000-0000-0000-0000-000000000003', 'ct100000-0000-0000-0000-000000000008',
...
INSERT INTO paiements (id, facture_id, montant, date_reception, saisie_manuelle) VALUES
  ('pa100000-0000-0000-0000-000000000001', 'fa100000-0000-0000-0000-000000000001', 385.00, '2025-02-25', false);

-- ----------------------------------------------------------
-- Notification de demo
-- ----------------------------------------------------------
INSERT INTO notifications (id, user_id, type, titre, message, lien) VALUES
  ('no100000-0000-0000-0000-000000000001',
   (SELECT id FROM users ORDER BY created_at LIMIT 1),
   'facture_retard',
   'Facture en retard',
