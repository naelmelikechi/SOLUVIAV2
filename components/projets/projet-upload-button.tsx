...
import { uploadProjetDocument } from '@/lib/actions/documents';
...
interface ProjetUploadButtonProps {
  projetId: string;
  projetRef: string;
}

export function ProjetUploadButton({
  projetId,
  projetRef,
}: ProjetUploadButtonProps) {
  ...
  async function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const result = await uploadProjetDocument(projetId, projetRef, formData);
