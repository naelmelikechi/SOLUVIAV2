...
export function OppDrawer({
  ...
  const confirmPerte = () =>
    start(() =>
      // setOpportuniteStatut revalide /pipeline (route courante) : refresh redondant.
      runWithToast(
  ...
  // toggleRelance revalide /relances ET /pipeline (route courante) : pas de refresh.
  const toggle = (id: string, fait: boolean) =>
    start(() => runWithToast(() => toggleRelance(id, fait)));
  return (
    <Sheet
      open
      onOpenChange={(o) => {
        ...
        <div className="space-y-4 px-4 pb-6">
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() =>
                start(() =>
                  // revalide /pipeline (route courante)
          ...
          <Tabs defaultValue="apercu">
            ...
            <TabsContent value="apercu" className="space-y-5 text-sm">
              <section className="space-y-2">
                ...
                {editing ? (
                  ...
                  <dl className="divide-border border-border divide-y overflow-hidden rounded-lg border">
                    ...
                    <Row
                      term="Apprentis visés"
                      value={opp.nb_alternants ?? '-'}
                    />
              ...
              {canNote && (
                <div className="space-y-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      start(() =>
                        // addNote revalide /pipeline
                        runWithToast(
                          () => addNote(opp.id, note, noteMentions),
                          {
