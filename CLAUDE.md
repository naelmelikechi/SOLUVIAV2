...
- Business refs auto-generated by triggers: project `0042-DUP-APP`, contract `CTR-00187`, invoice `FAC-SOL-0012` (credit note `AVR-SOL-0003`; `SOL` = issuing company, not the client)
