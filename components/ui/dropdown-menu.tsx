...
function DropdownMenuLabel({
  ...
  // Intentionally NOT using MenuPrimitive.GroupLabel: it requires being wrapped
  // in a Menu.Group (otherwise Base UI throws error #31).
  // We use a plain div for standalone labels in menus.
  return (
    <div
